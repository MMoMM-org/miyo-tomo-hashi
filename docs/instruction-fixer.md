...
Only 7 of the 14 action kinds carry a repairable target field (the ones where a mechanical
...
- [Action reference](action-reference.md) — all 14 action kinds; the 7 with a repairable
