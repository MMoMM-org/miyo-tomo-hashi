...
- [x] **T3.1 `SuggestionsEditorView` leaf + tab chrome** `[activity: frontend-ui]`
...
- [x] **T3.2 Suggestions tab — worthy vs suppressed cards** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.3 SpotPicker (op 2)** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.4 Fuzzy pickers (MOC / tags / template / location / parent)** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.5 Proposed MOCs tab** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.6 Daily tab** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.7 Tag-Handler tab** `[activity: frontend-ui]` `[parallel: true]`
...
- [x] **T3.8 Phase Validation** `[activity: validate]`
