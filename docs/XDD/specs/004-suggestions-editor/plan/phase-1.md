...
- [x] **T1.1 EditModel types + schema version gate** `[activity: domain-modeling]`
...
- [x] **T1.2 `SuggestionsDoc` port + `FakeSuggestionsDoc`** `[activity: domain-modeling]`
...
- [x] **T1.3 Suggestion field transforms (op 1, op 4, note fields)** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.4 Force-Atomic stem-sync** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.5 Proposed-MOC graph ops (rename / reparent / decision / merge)** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.6 `validPlacements(anchorType)`** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.7 Daily edit transforms (content / position / time / accept)** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.8 Tag-handler toggle transform** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.9 `suggestionsStore` (`Store<T>`)** `[activity: domain-modeling]`
...
- [x] **T1.10 Phase Validation** `[activity: validate]`
