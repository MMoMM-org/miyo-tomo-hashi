...
- [ ] **T3.1 Discovery resolver + lister** `[activity: backend-api]`
...
- [ ] **T3.2 Command dispatch by suffix + opener + doc picker** `[activity: frontend-ui]`
...
- [ ] **T3.3 View registration wiring** `[activity: frontend-ui]`
