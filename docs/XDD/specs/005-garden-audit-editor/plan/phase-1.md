...
- [x] **T1.1 Garden-audit wire types + vendored schema** `[activity: domain-modeling]`
...
- [x] **T1.2 Ajv2020 validator (accept + reject)** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T1.3 Current-shape fixture + emit_digest round-trip** `[activity: test]`
