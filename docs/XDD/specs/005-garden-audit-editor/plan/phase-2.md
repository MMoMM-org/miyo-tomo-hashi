...
- [x] **T2.1 GardenAuditDoc port + ObsidianGardenAuditDoc adapter** `[activity: backend-api]`
...
- [x] **T2.2 Garden-audit transforms (pure setters)** `[activity: domain-modeling]` `[parallel: true]`
