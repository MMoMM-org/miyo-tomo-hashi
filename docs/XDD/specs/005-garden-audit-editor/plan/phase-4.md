...
- [ ] **T4.1 GardenAuditEditorView lifecycle** `[activity: frontend-ui]`
...
- [ ] **T4.2 GardenAuditTab — tier-grouped shell** `[activity: frontend-ui]`
...
- [ ] **T4.3 Save / Revert / dirty affordance** `[activity: frontend-ui]`
...
- [ ] **T4.4 Empty & error states** `[activity: frontend-ui]`
